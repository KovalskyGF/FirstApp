...
<html lang="en">
  ...
  <body>
  	          ...
  	          <div class="row justify-content-between align-items-center">
  	             ...
  	             <div class="col-md-auto">
  	                 <ul class="top-nav_menu">
  	                    ...
  	                    <li><a href="about.php" style="color:#e24486">О компании</a></li>
   ...
   <div class="row">
   	...
   	<div class="col-md-8">
       <div class="content">
       <img src="img/objects/about.jpg" style="height: 228px; margin: 0 0 20px;" alt="about">
         <?php
           ...
           $query = "SELECT tittle, text FROM news WHERE news_id=3";
