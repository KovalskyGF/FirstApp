...
<html lang="en">
  <head>
    ...
    <title>Капитальный ремонт помещений</title>
     <!-- Bootstrap grid CSS -->
  ...
  <body>
   ...
   <div class="row">
   	  <div class="col-md-4">
              ...
              <li><a href="6.php" style="background-color: #0086e1; color: white;">Капитальный ремонт помещений</a></li>
   			    </ul>
       ...
       <div class="content">
         <?php
           ...
           $query = "SELECT tittle, text FROM article WHERE article_id=6";
